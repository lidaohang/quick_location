...
### 接入层platform集群异常
#### 现象
通过监控插件发现在2017.09.25 19点platform集群请求流量出现大量的499，5xx状态码。并且发现机器cpu使用率升高，目前一直持续中。
...
#### 案例总结
- 分析请求流量异常，得出nginx upstream后端机器响应时间拉长
- 分析nginx进程cpu高，得出nginx内部模块代码有耗时的json解析以及内存分配回收操作
